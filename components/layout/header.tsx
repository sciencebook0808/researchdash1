...
export function Header() {
  ...
  return (
    <>
      <header 
        className="h-14 border-b border-border flex items-center px-4 md:px-6 gap-3 md:gap-4 bg-background/80 backdrop-blur-sm sticky top-0 z-20"
        role="banner"
      >
        ...
        >
          ...
          <div className="ml-auto hidden sm:flex items-center gap-1" aria-hidden="true">
        ...
        <div className="ml-auto flex items-center gap-2 flex-shrink-0">
          <div 
            className="hidden sm:flex items-center gap-1.5 px-2.5 py-1.5 rounded-md border border-emerald-500/20 bg-emerald-500/5"
            role="status"
